...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/images/logo/fipand-logo.svg') ?>">
    ...
    <link rel="stylesheet" href="<?= base_url('assets/home/css/tiny-slider.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/css/aos.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/css/glightbox.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/css/style.css') ?>">

    <link rel="stylesheet" href="<?= base_url('assets/home/css/flatpickr.min.css') ?>">


    <title>Jokojoki - Starter Template</title>
</head>
...
<body>
            ...
            <div class="menu-bg-wrap">
                <div class="site-navigation">
                    <div class="row g-0 align-items-center">
                        <div class="col-2">
                            <a href="/" class="logo m-0 float-start">JokoJoki<span class="text-primary">.</span></a>
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center pt-5">
                <div class="col-lg-6 text-center pe-lg-5">
                    <h1 class="heading text-white mb-3" data-aos="fade-up">CI4 Starter Template</h1>
                    <p class="text-white mb-4" data-aos="fade-up" data-aos-delay="100">CodeIgniter4 starter template with admin page, simple authentication, and edit profile. Using Bootstrap 5.</p>
                    <div class="align-items-center mb-4" data-aos="fade-up" data-aos-delay="200">
                        <a href="/auth/login" class="btn btn-outline-white-reverse me-4">Login</a>
                        <a href="/" class="text-white glightbox">Souce Code</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card post-entry">
                        <img src="/assets/home/images/img-1.jpg" class="card-img-top" alt="Image">
                        <div class="card-body">
                ...
                <div class="col-lg-4">
                    <div class="card post-entry">
                        <img src="/assets/home/images/img-2.jpg" class="card-img-top" alt="Image">
                        <div class="card-body">
                            <div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
                            <h5 class="card-title"><a href="#">Behind the word mountains</a></h5>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                ...
                <div class="col-lg-4">
                    <div class="card post-entry">
                        <img src="/assets/home/images/img-3.jpg" class="card-img-top" alt="Image">
                        <div class="card-body">
                            <div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
                            <h5 class="card-title"><a href="#">Behind the word mountains</a></h5>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
    ...
    <script src="<?= base_url('assets/home/js/flatpickr.min.js') ?>"></script>


    <script src="<?= base_url('assets/home/js/aos.js') ?>"></script>
    <script src="<?= base_url('assets/home/js/glightbox.min.js') ?>"></script>
    <script src="<?= base_url('assets/home/js/navbar.js') ?>"></script>
    <script src="<?= base_url('assets/home/js/counter.js') ?>"></script>
